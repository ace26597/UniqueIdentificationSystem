...
<body>
  ...
  <fieldset>
  <form class="box login" role="form" method="post" action="esmodify1.php">
  <div class="col-2">
    <label>
      Mother's name
        <?php
      ...
      $row = mysql_fetch_assoc($query);
      ?>
      <input class="form-control" value="<?php echo $row['mother']?>" placeholder="Mother's name" id="mother" name="mother" tabindex="1">
    </label>
  </div>
  <div class="col-2">
    <label>
      ...
      $row = mysql_fetch_assoc($query);
      ?>
      <input class="form-control" value="<?php echo $row['father']?>" placeholder="Father's name" id="father" name="father" tabindex="2">
    </label>
  </div>
  ...
  <div class="col-3">
    <label>
      ...
      $row = mysql_fetch_assoc($query);
      ?>
      <input class="form-control" value="<?php echo $row['siblings']?>" placeholder="Number of Siblings" id="siblings" name="siblings" tabindex="3">
    </label>
  </div>
  <div class="col-3">
    <label>
      ...
      $row = mysql_fetch_assoc($query);
      ?>
      <input class="form-control" value="<?php echo $row['wife']?>" placeholder="Wife's Name" id="wife" name="wife" tabindex="4">
    </label>
  </div>
  <div class="col-4">
    <label>
      ...
      $row = mysql_fetch_assoc($query);
      ?>
      <input class="form-control" value="<?php echo $row['child1']?>" placeholder="children name-1" id="child1" name="child1" tabindex="5">
    </label>
  </div>
  <div class="col-4">
    <label>
      ...
      $row = mysql_fetch_assoc($query);
      ?>
      <input class="form-control" value="<?php echo $row['child2']?>" placeholder="children name-2" id="child2" name="child2" tabindex="6">
    </label>
  </div>
  <div class="col-4">
    <label>
      ...
      $row = mysql_fetch_assoc($query);
      ?>
      <input class="form-control" value="<?php echo $row['child3']?>" placeholder="children name-3" id="child3" name="child3" tabindex="7">
    </label>
  </div>
...
<div class="col-5">
    <label>
      ...
      $row = mysql_fetch_assoc($query);
      ?>
      <input class="form-control" value="<?php echo $row['social1']?>" placeholder="Social Contribution" id="social1" name="social1" tabindex="8">
    </label>
  </div>
...
<label>
      ...
      $row = mysql_fetch_assoc($query);
      ?>
      <input class="form-control" value="<?php echo $row['social2']?>" placeholder="Social Contribution" id="social2" name="social2" tabindex="9">
    </label>
  </div>
...
<label>
      ...
      $row = mysql_fetch_assoc($query);
      ?>
      <input class="form-control" value="<?php echo $row['social3']?>" placeholder="Social Contribution" id="social3" name="social3" tabindex="10">
    </label>
  </div>
...
{  
    ...
    $insert_family="update family_info set mother='$user_mother', father='$user_father', siblings='$user_siblings', wife='$user_wife', child1='$user_child1', child2='$user_child2', child3='$user_child3' where UID=".$var; 
    $insert_social="update social_info set social1='$user_social1',social2='$user_social2',social3='$user_social3' where UID=".$var;
    
if(mysqli_query($dbcon,$insert_family))  
    {  
        if(mysqli_query($dbcon, $insert_social))
        {
            echo"<script>window.open('essearchmod.php','_self')</script>";  
